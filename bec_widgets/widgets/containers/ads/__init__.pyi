...
class CAutoHideSideBar(QtWidgets.QScrollArea):
    def __init__(
        self, parent: typing.Optional["CDockContainerWidget"], area: "SideBarLocation"
    ) -> None: ...
    def dockContainer(self) -> typing.Optional["CDockContainerWidget"]: ...
    ...
    def removeAutoHideWidget(
        self, AutoHideWidget: typing.Optional["CAutoHideDockContainer"]
    ) -> None: ...
...
class CDockWidget(QtWidgets.QFrame):
    ...
    def setAutoHide(
        self, Enable: bool, Location: "SideBarLocation" = ..., TabIndex: int = ...
    ) -> None: ...
...
class CDockAreaTabBar(QtWidgets.QScrollArea):
    ...
    elidedChanged: typing.ClassVar[Signal]
    ...
    currentChanging: typing.ClassVar[Signal]
...
class CDockAreaWidget(QtWidgets.QFrame):
    ...
    def __init__(
        self,
        DockManager: typing.Optional[CDockManager],
        parent: typing.Optional[CDockContainerWidget],
    ) -> None: ...
    ...
    def setVisible(self, Visible: bool) -> None: ...
    def titleBarButton(
        self, which: "TitleBarButton"
    ) -> typing.Optional[QtWidgets.QAbstractButton]: ...
    def features(self, Mode: "eBitwiseOperator" = ...) -> "CDockWidget.DockWidgetFeature": ...
    @staticmethod
    def restoreState(
        Stream: "CDockingStateReader",
        Testing: bool,
        ParentContainer: typing.Optional["CDockContainerWidget"],
    ...
    def toggleDockWidgetView(
        self, DockWidget: typing.Optional["CDockWidget"], Open: bool
    ) -> None: ...
...
class CDockContainerWidget(QtWidgets.QFrame):
    ...
    dockAreaViewToggled: typing.ClassVar[Signal]
    dockAreasRemoved: typing.ClassVar[Signal]
...
class CDockFocusController(QtCore.QObject):
    ...
    def notifyFloatingWidgetDrop(
        self, FloatingWidget: typing.Optional["CFloatingDockContainer"]
    ) -> None: ...
    def notifyWidgetOrAreaRelocation(
        self, RelocatedWidget: typing.Optional[QtWidgets.QWidget]
    ) -> None: ...
...
class CDockManager(CDockContainerWidget):
    ...
    focusedDockWidgetChanged: typing.ClassVar[Signal]
    ...
    perspectiveListLoaded: typing.ClassVar[Signal]
    ...
    def lockDockWidgetFeaturesGlobally(
        self, Features: CDockWidget.DockWidgetFeature = ...
    ) -> None: ...
    ...
    def setDockWidgetToolBarIconSize(
        self, IconSize: QtCore.QSize, State: CDockWidget.eState
    ) -> None: ...
    ...
    def removeDockWidget(self, Dockwidget: typing.Optional["CDockWidget"]) -> None: ...
    def findDockWidget(
        self, ObjectName: typing.Optional[str]
    ) -> typing.Optional["CDockWidget"]: ...
    ...
    def removeDockContainer(
        self, DockContainer: typing.Optional["CDockContainerWidget"]
    ) -> None: ...
    def registerDockContainer(
        self, DockContainer: typing.Optional["CDockContainerWidget"]
    ) -> None: ...
    def removeFloatingWidget(
        self, FloatingWidget: typing.Optional["CFloatingDockContainer"]
    ) -> None: ...
    def registerFloatingWidget(
        self, FloatingWidget: typing.Optional["CFloatingDockContainer"]
    ) -> None: ...
...
class CDockWidgetTab(QtWidgets.QFrame):
    ...
    activeTabChanged: typing.ClassVar[Signal]
    def setVisible(self, visible: bool) -> None: ...
    def buildContextMenu(
        self, menu: typing.Optional[QtWidgets.QMenu] = ...
    ) -> typing.Optional[QtWidgets.QMenu]: ...
...
class CFloatingDockContainer(QtWidgets.QWidget, IFloatingWidget):
    ...
    def restoreState(self, Stream: "CDockingStateReader", Testing: bool) -> bool: ...
    def moveFloating(self) -> None: ...
    def initFloatingGeometry(
        self, DragStartMousePos: QtCore.QPoint, Size: QtCore.QSize
    ) -> None: ...
...
class CFloatingDragPreview(QtWidgets.QWidget, IFloatingWidget):
    ...
    def __init__(
        self,
        Content: typing.Optional[QtWidgets.QWidget],
        parent: typing.Optional[QtWidgets.QWidget],
    ) -> None: ...
    @typing.overload
    ...
    draggingCanceled: typing.ClassVar[Signal]
